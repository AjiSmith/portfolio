            ...
            <section className="bg-[#151515] py-32 relative">
                <div className="container mx-auto px-6 flex flex-col md:flex-row items-center gap-16" data-aos="fade-up">
                    <div className="md:w-1/2">
                        <h2 className="text-6xl font-black mb-2 tracking-tighter">About Me</h2>
                        <p className="text-thistle italic mb-6 opacity-60">"{data.profile.motto}"</p>
                        <p className="text-5xl md:text-7xl font-extrabold leading-none mb-2 bg-gradient-to-r from-yellow-400 via-indigo-400 to-indigo-600 bg-clip-text text-transparent">
                            Hi!, I'm </p>
                        <p className="text-4xl md:text-5xl font-bold leading-tight mb-8 text-white">
                            Azimas Perwata Saputra</p>
